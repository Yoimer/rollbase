...
var customerName_validated = rbv_api.selectQuery("SELECT clientcode_ FROM dim_ApiCustomer_t1 WHERE clientname_#value='" + customerName + "'", 1);
...
if (customerName_validated.length > 0) {
    ...
    rbv_api.createRecord("dim_APIContracts_t12", arr);
